  ...
  describe 'paths_with_number_of_visits' do
    ...
    context 'when order is ascending' do
      it 'returns an array with paths and its numbers of visits' do
        ...
        expect(web_log.paths_with_number_of_visits(order: :ascending)).to eq(
          ['/home 78 visits', '/help_page/1 80 visits', '/about 81 visits', '/index 82 visits',
           '/contact 89 visits', '/about/2 90 visits']
        )
      end
    end
  end
